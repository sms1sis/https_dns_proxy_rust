...
The JNI functions are currently named for the package `io.github.SafeDNS`. If your app uses a different package name, you **must** update the function names in `src/lib.rs`.
